...
import com.s33me.myhackrf.Hackrf;
import com.s33me.myhackrf.HackrfCallbackInterface;
import com.s33me.myhackrf.HackrfUsbException;
...
public class MainActivity extends AppCompatActivity implements Runnable, HackrfCallbackInterface{
    ...
    //9-16-2020 added by Martin
    private final long drone1_freq = 2400000000L;
    private final long drone2_freq = 5800000000L;
    private final long drone3_freq = 3400000000L;
    private final long bluetooth_freq = 2483000000L;
    private final long fan_freq = 304000000L;
    private final long simplex_freq = 146520000L;
     ...
     *
     * @param hackrf	Instance of the com.s33me.myhackrf.Hackrf class that represents the open device
     */
    @Override
            ...
            while(!this.stopRequested)
            {
                ...
                else
                {
                    printOnScreen("Error: Queue is empty! (This happens most often because the queue ran full"
                            + " which causes the com.s33me.myhackrf.Hackrf class to stop receiving. Writing the samples to a file"
